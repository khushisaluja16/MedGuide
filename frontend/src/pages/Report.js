...
function ResultCard({ icon, title, items, loading, accent, learnMore }) {
  const accentMap = {
    ...
    >
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <span style={{ fontWeight: "700", fontSize: "16.5px", color: "#1e3a5f", letterSpacing: "-0.2px" }}>
            {title}
          </span>
        </div>
        {learnMore && (
          <button style={{
            padding: "5px 14px", borderRadius: "20px", fontSize: "12.5px",
      ...
      <div style={{ flex: 1 }}>
        {loading ? (
          ...
          <p style={{ margin: 0, color: "#9ca3af", fontStyle: "italic", fontSize: "14.5px", lineHeight: "1.7" }}>
    ...
    <div style={{ display: "flex", justifyContent: isUser ? "flex-end" : "flex-start", marginBottom: "10px" }}>
      {!isUser && (
        <div style={{
          ...
          display: "flex", alignItems: "center", justifyContent: "center",
          fontSize: "13px", marginRight: "7px", flexShrink: 0, alignSelf: "flex-end",
        }}>🩺</div>
      )}
      <div style={{
        maxWidth: "80%",
...
Lifestyle: ${results.lifestyleSuggestions?.join("; ")}.`
  ...
  return (
    <div style={{
      ...
      {/* Navbar — auto-highlights "Reports" because pathname is /report */}
      <Navbar />
      ...
      <div style={{ display: "flex", gap: "20px", flex: 1, alignItems: "stretch" }}>
        ...
        {/* ══════════════════════════════════════════════════════════════
            LEFT — Patient Input
            ══════════════════════════════════════════════════════════════ */}
        <div style={{ width: "23%", minWidth: "210px", display: "flex", flexDirection: "column" }}>
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{ margin: 0, fontSize: "16.5px", fontWeight: "700", color: "#1e3a5f" }}>
                Patient Details
              </h3>
            </div>
                ...
                {file.type.startsWith("image/") ? (
                  ...
                  <div style={{ padding: "12px 14px", display: "flex", alignItems: "center", gap: "10px" }}>
                    ...
                    <div style={{ flex: 1, overflow: "hidden" }}>
                      ...
                      <p style={{ margin: "2px 0 0", fontSize: "11.5px", color: "#6b7280" }}>PDF Document</p>
                    </div>
                  </div>
                )}
                <div style={{
                  ...
                  <a href={fileURL} target="_blank" rel="noopener noreferrer" style={{
                    fontSize: "12px", color: "#2b7de9", fontWeight: "700",
                    textDecoration: "none", background: "#dbeafe",
                    padding: "3px 11px", borderRadius: "20px", whiteSpace: "nowrap",
                  }}>👁 View</a>
                </div>
              </div>
            )}
            ...
            {[
              ...
              <div key={f.key} style={{ marginBottom: "11px" }}>
                <label style={{ display: "block", fontSize: "14px", fontWeight: "600", color: "#1e3a5f", marginBottom: "5px" }}>
                  {f.label}
                </label>
                <input
                  value={form[f.key]}
            ...
            <button onClick={handleAnalyse} disabled={loading} style={{
              ...
              color: "white", fontWeight: "700", fontSize: "15.5px",
            ...
            <p style={{ fontSize: "11.5px", color: "#9ca3af", marginTop: "14px", lineHeight: "1.6", textAlign: "center" }}>
              ⚠️ AI-assisted only. Always consult a qualified doctor.
            </p>
          </div>
        </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{
            ...
            <div>
              <h2 style={{ margin: "0 0 4px", fontSize: "21px", fontWeight: "800", color: "white", letterSpacing: "-0.3px" }}>
                {reportTitle ? `Report Analysis: ${reportTitle} — ${todayStr}` : "AI-Powered Health Report Analysis"}
              </h2>
              <p style={{ margin: 0, fontSize: "14px", color: "rgba(255,255,255,0.78)", fontWeight: "500" }}>
                {reportTitle
          ...
          <div style={{
            ...
            <ResultCard icon="🔬"    title="Possible Diseases"
              items={results?.possibleDiseases}     loading={loading} accent="blue" learnMore />
          ...
          {results && (
            <div style={{
              ...
              <p style={{ margin: 0, fontSize: "13.5px", color: "#92400e", fontWeight: "500", lineHeight: "1.6" }}>
        ...
        <div style={{ width: "25%", minWidth: "220px", display: "flex", flexDirection: "column" }}>
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <p style={{ margin: 0, color: "white", fontWeight: "700", fontSize: "15px" }}>MedGuide AI</p>
                <p style={{ margin: 0, color: "rgba(255,255,255,0.7)", fontSize: "12px" }}>Ask about your report</p>
              </div>
              <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "5px" }}>
                ...
                <span style={{ color: "rgba(255,255,255,0.75)", fontSize: "11.5px" }}>Online</span>
              </div>
            </div>
            ...
            <div style={{
              ...
              <textarea rows={2} value={chatInput}
                ...
                style={{
                  ...
                  border: "1.5px solid #d1dff5", fontSize: "14px",
